...
import styles from './SuppliesCatalogue.module.scss'
...
export default function SuppliesCatalogue () {
  //
      ...
      <Card className={styles.CardProfile}>
        ...
        <div className={styles.flex + ' ' + styles.gap40 + ' ' + styles.marginB20}>
          <div className={styles.col_33}>
            ...
            <div className={styles.inventory}>Catálogos de insumos</div>
            <div>
        ...
        <div className={styles.divshare}>
          <Card className={styles.CardProfile}>
            <div className={styles.flexJustify}>
              <Link href='/system/profile/company/event/1/supplies-catalogue/create'>
                <div className={styles.adddiv}>
                  <img src={plusLogo?.src} width={42} height={42} />
                  <p className={styles.inventory}>Crear catálogo</p>
                </div>
              </Link>
              <div className={styles.inventory}>En esta sección verá el detalle de catalogo de insumos</div>
            </div>
            {list.map((item, key) => {
              return (
                <div className={`${styles.card} ${styles.mb50}`} key={key}>
                  <div className={styles.title}>
                    <div className={styles.divTitleL}>
                      <h1>{item.text}</h1>
                    </div>
                    <div />
