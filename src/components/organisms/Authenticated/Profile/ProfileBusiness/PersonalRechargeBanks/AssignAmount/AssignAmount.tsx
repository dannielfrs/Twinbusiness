...
import styles from './AssignAmount.module.scss'
...
export default function AssignAmount() {
          ...
          <Card className={styles.CardBottom}>
            <Card className={styles.CardUser}>
              <div className={styles.infoProfile}>
                <div className={styles.image}>
                  <Image src={robertpattinson} alt='' />
                </div>
                <p className={styles.name}>Robert pattinson</p>
              </div>
              <div className={styles.contact}>
                <p>Correo: robert.pattinson@gmail.com</p>
                <p>Número: 335453-8975</p>
              </div>
