...
const Form1: React.FC<ComponentProps> = ({ onClickBack }) => {

  const { dataSecondStep, setSecondStep } = useContext(WebEventContext)
  ...
  useEffect(() => {
    if (Object.keys(dataSecondStep).length > 0) {
      for (const propertyName in dataSecondStep) {
        methods.setValue(propertyName, dataSecondStep[propertyName] === 1)
      }
    }
  }, [dataSecondStep])
  ...
  return (
    <div className={styles.ContForm}>
      <BackBlackCss>
        <FormHookProvider methods={methods} onSubmit={setSecondStep}>
          <div className={styles.Form1}>
            <p>
              Gracias por confiar en nosotros y formar parte de grupo <strong>Twin</strong>
            </p>
            <br></br> <br></br><br></br>
            <p>
              Al registrar sus datos obtendrá acceso a la plataforma más completa del mundo para organizar sus eventos
            </p>
            <br></br> <br></br><br></br>
            <p>
              Lo invitamos a subir los datos de su promotora
            </p> <br></br>
            <div className={styles.aceptconditions}>
              ...
              <div className={styles.description}>
                <p>He leído y acepto los <Link href="/system/terms-and-conditions">términos y condiciones</Link> de la pasarela de pagos de Twinbusiness/Twinevents</p>
              </div>
              <div className={styles.checkbox}>
                <Checkbox
                  name="policy"
              ...
              <div className={styles.description}>
                <p>He leído y acepto las Condiciones del servicio, <Link href="#">Políticas de privacidad</Link> de Twinbusiness/Twinevents</p>
              </div>
            </div>
            <div>
              <p className={styles.indicationsLabel}>Presione <strong>Subir empresa</strong> para seguir con el proceso o presione<br></br> <strong>Regresar al Home</strong> para volver al inicio.</p>
            </div>
        ...
        <div className={styles.TermsAndConditions}>
          <Card className={styles.cardTerms}>
            <div className={styles.ButtonClose}>
              <Button variant='terms' className={styles.close} onClick={() => setModalIsOpen(false)}>x</Button>
            </div>
